        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                    <input id="ShenPiShiXiang" name="ShenPiShiXiang" type="text" value="${doc.name}" class="form-control" placeholder="审批事项" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="ShenPiShiXiang" cf_modelitemname="审批事项">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                    <input id="XuKeZhengHaoMa" name="XuKeZhengHaoMa" value="" class="form-control" placeholder="申请事项内容" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="XuKeZhengHaoMa" cf_modelitemname="许可证号码" type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11" style="font-size:12px;">
                        ...
                        <label style="font-weight: normal;">
                            <input  name="XieYeShiYou" type="radio" value="遗失" class="shiyou cfRadio" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_radio" cf_modelitemid="XieYeShiYou" cf_modelitemname="歇业事由">遗失                        <span class="CheckBoxs" style="font-size: 12px;">(
                        ...
                        <label style="font-weight: normal;">
                        <input name="XieYeShiYou" type="radio" value="毁损" class="huisun cfRadio" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_radio" cf_modelitemid="XieYeShiYou" cf_modelitemname="歇业事由" cf_ismirrorfield="true">毁损<span class="CheckBoxs" style="font-size: 12px;">(
                            <input name="XieYeSunHui" type="checkbox" value="许可证正本" class="cfCheckBox" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_checkbox" cf_modelitemid="XieYeSunHui" cf_modelitemname="歇业损毁">许可证正本
                            <input name="XieYeSunHui" type="checkbox" value="副本" class="cfCheckBox" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_checkbox" cf_modelitemid="XieYeSunHui" cf_modelitemname="歇业损毁">副本
                            <span>)</span>
                            </span>
                        </label>
                        <textarea id="TingYeShiYou" name="TingYeShiYou" value="" class="form-control" cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="TingYeShiYou" cf_modelitemname="歇业事由" minheight="80" maxheight="200"></textarea>
                    </div>
                </div>
