        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="form-group" style="display: none">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <input id="GuangGaoShenQingDanWei" name="GuangGaoShenQingDanWei" type="text" value="" class="form-control" placeholder="广告申请单位" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="GuangGaoShenQingDanWei" cf_modelitemname="广告申请单位">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">统一社会信用代码：</label>
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <input id="TongYiSheHuiXinYongDaiMa" name="TongYiSheHuiXinYongDaiMa" type="text" value="${company.creditCode}" class="form-control" placeholder="统一社会信用代码" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="TongYiSheHuiXinYongDaiMa" cf_modelitemname="统一社会信用代码">
                    </div>
                </div>
            ...
            <div class="form-group">
               ...
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
               <input id="JingYingChangSuo" name="JingYingChangSuo" type="text" value="${company.enterpriserAddress}" class="form-control" placeholder="经营场所" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="JingYingChangSuo" cf_modelitemname="经营场所">
               </div>
            </div>
            <div class="form-group">
               <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">设置地点：</label>
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                   <input id="SheZhiDiDian" name="SheZhiDiDian" type="text" value="" class="form-control" placeholder="设置地点" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="SheZhiDiDian" cf_modelitemname="设置地点">
               </div>
            </div>
            <div class="form-group">
               <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">法定代表人(经营者)：</label>
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                   <input id="FaDingDaiBiaoRenJingYingZhe" name="FaDingDaiBiaoRenJingYingZhe" type="text" value="${company.legalPersonName}" class="form-control" placeholder="法定代表人(经营者)" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="FaDingDaiBiaoRenJingYingZhe" cf_modelitemname="法定代表人(经营者)">
               </div>
            </div>
            <div class="form-group">
                <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">电话：</label>
                <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                  <input id="FaDingDaiBiaoRenDianHua" name="FaDingDaiBiaoRenDianHua" type="text" value="${company.legalPersonPhone}" class="form-control frlxdh" placeholder="法定代表人电话" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="FaDingDaiBiaoRenDianHua" cf_modelitemname="法定代表人电话">
                </div>
           </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                    <input id="FaRenShenFenZhengHao" name="FaRenShenFenZhengHao" type="text" value="${company.legalPersonId}" class="form-control sfzhm" placeholder="法人身份证号" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="FaRenShenFenZhengHao" cf_modelitemname="法人身份证号">
                    </div>
            </div>
            <div class="form-group">
               <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">联系人：</label>
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                  <input id="LianXiRen" name="LianXiRen" type="text" value="${userVertifyInfo.name}" class="form-control" placeholder="联系人" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="LianXiRen" cf_modelitemname="联系人">
               </div>
            </div>
            <div class="form-group">
               <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">联系人电话：</label>
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                  <input id="LianXiRenDianHua" name="LianXiRenDianHua" type="text" value="${userVertifyInfo.tel}" class="form-control jbrdh" placeholder="联系人电话" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="LianXiRenDianHua" cf_modelitemname="联系人电话">
            ...
            <div class="form-group">
               ...
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                   <input id="GuangGaoShiYongDanWei" name="GuangGaoShiYongDanWei" type="text" value="" class="form-control" placeholder="广告使用单位" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="GuangGaoShiYongDanWei" cf_modelitemname="广告使用单位">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                   <input id="FaDingDaiBiaoRenShiYongZhe" name="FaDingDaiBiaoRenShiYongZhe" type="text" value="" class="form-control" placeholder="法定代表人(使用者)" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="FaDingDaiBiaoRenShiYongZhe" cf_modelitemname="法定代表人(使用者)">
                </div>
            </div>
                <div class="form-group">
                    <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">电话：</label>
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <input id="FaDingDaiBiaoRenShiYongDianHua" name="FaDingDaiBiaoRenShiYongDianHua" type="text" value="" class="form-control fddbrdh" placeholder="法定代表人使用电话" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="FaDingDaiBiaoRenShiYongDianHua" cf_modelitemname="法定代表人使用电话">
                    </div>
                </div>
                <div class="form-group">
