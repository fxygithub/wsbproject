...
mso-bidi-language:AR-SA">(
                        ...
                        <label style="font-weight: normal">
                        <input id="BuBanShiYou" name="BuBanShiYou" type="radio" value="毁损" class="huisun cfRadio" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_radio" cf_modelitemid="BuBanShiYou" cf_modelitemname="补办事由">毁损
...
EN-US;mso-fareast-language:ZH-CN;mso-bidi-language:AR-SA">
                      ...
                      <textarea id="YiShiHuoSunHuiQingYou" name="YiShiHuoSunHuiQingYou" value="" class="form-control" cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="YiShiHuoSunHuiQingYou" cf_modelitemname="遗失或损毁情由" minheight="80" maxheight="200"></textarea>
                    </div>
                </div>
