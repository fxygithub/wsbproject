            ...
            <div class="form-group">
               ...
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <textarea id="TingYeShiYou" name="TingYeShiYou" value="${banjianInof.data.TingYeShiYou}" class="form-control" cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="TingYeShiYou" cf_modelitemname="停业事由" minheight="80" maxheight="200">${banjianInof.data.TingYeShiYou}</textarea>
                    </div>
                </div>
                <div class="form-group">
