...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="sx_title"><h3>烟草专卖零售许可证-恢复营业</h3></div>
            ...
            <div class="form-group">
               ...
               <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                ...
                <div class="form-group">
                    <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">恢复营业事由：</label>
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <textarea id="TingYeShiYou" name="TingYeShiYou" value="" class="form-control" cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="TingYeShiYou" cf_modelitemname="恢复营业事由" minheight="80" maxheight="200">${banjianInof.data.TingYeShiYou}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">申请恢复营业期限&nbsp;:</label>
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11" style="padding:0;">
                        <span style="font-size: 12px;">自</span>
                        <input type="text" class="span2" value="${banjianInof.data.HuiFuYingYeKaiShiShiJian}" id="dpd1" name="HuiFuYingYeKaiShiShiJian"><span style="font-size: 12px;">至</span><input type="text" class="span2" value="${banjianInof.data.HuiFuYingYeJieShuShiJian}" id="dpd2" name="HuiFuYingYeJieShuShiJian">
                    </div>
                </div>
