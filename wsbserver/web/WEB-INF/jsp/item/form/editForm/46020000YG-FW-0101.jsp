        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <form class="form-horizontal" name="市烟草局_烟草专卖零售许可证停业恢复营业补办歇业(综合)" method="post" onsubmit="return false" action="http://199.224.253.9:8081/cform/view?formId=ShiYanCaoJu_TYHFYYBBXYZH" cf_elementtype="form" cf_themeid="default" cf_iscreatetable="1" cf_fieldcounter="24" id="ShiYanCaoJu_TYHFYYBBXYZH" cf_appcode="INSPUR-DZZW-YSL" cf_iscreateid="1" cf_modelid="ShiYanCaoJu_TYHFYYBBXYZH" cf_modelname="市烟草局_烟草专卖零售许可证停业恢复营业补办歇业（综合）">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <input id="XuKeZhengHaoMa" name="XuKeZhengHaoMa" value="${banjianInof.data.XuKeZhengHaoMa}" class="form-control" placeholder="申请事项内容" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="XuKeZhengHaoMa" cf_modelitemname="申请事项内容" type="text">
                ...
                <div class="form-group">
                    <label class="col-xs-4 col-sm-2 col-md-1 col-lg-1 control-label item">委托代理人111：</label>
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <input id="WeiTuoDaiLiRen" name="WeiTuoDaiLiRen"
                               value="${banjianInof.data.WeiTuoDaiLiRen}" class="form-control" placeholder="委托代理人" cf_fieldlength="100" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_text" cf_modelitemid="WeiTuoDaiLiRen" cf_modelitemname="委托代理人 " type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <textarea id="TingYeShiYou" name="TingYeShiYou" value="" class="form-control" cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="TingYeShiYou" cf_modelitemname="停业事由" minheight="80" maxheight="200">${banjianInof.data.TingYeShiYou}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        ...
                        <input type="text" class="span2" value="${banjianInof.data.TingYeKaiShiShiJian}" id="dpd1" name="TingYeKaiShiShiJian"><span style="font-size: 12px;">至</span><input type="text" name="TingYeJieShuShiJian" class="span2" value="${banjianInof.data.TingYeJieShuShiJian}" id="dpd2">
                    </div>
                </div>
