        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <form class="form-horizontal" name="市受理表单" method="post" onsubmit="return false"
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8 col-sm-10 col-md-11 col-lg-11">
                        <textarea id="XuKeNaRong" name="XuKeNaRong" value="${banjianInof.data.XuKeNaRong}" class="form-control"  cf_fieldlength="500" cf_elementtype="field" cf_iscreateid="1" cf_widgetid="cf_textarea" cf_modelitemid="XuKeNaRong" cf_modelitemname="许可内容" minheight="80" maxheight="200">${banjianInof.data.XuKeNaRong}</textarea>
